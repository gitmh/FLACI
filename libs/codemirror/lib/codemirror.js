  ...
  StringStream.prototype = {
    ...
    match: function(pattern, consume, caseInsensitive) {
      if (typeof pattern == "string") {
        ...
        // CHANGE MH: allow Lookback for last character
        var isB = this.pos > 0 && (pattern+"").indexOf("/^(?:\\b") == 0;
        if(isB && this.string[this.pos-1] != " " && this.string[this.pos-1] != ">" && this.string[this.pos-1] != "|") return null;
